...
console.log('Grandes poderes trazem grandes responsabilidadees.')
...
console.log(winterMessage[winterMessage.length - 3])
...
const realBestMovie = bestMovie.substr(0, 36) + '"Moonlight"!'
